...
@section('content')
                ...
                <div class="bg-white">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4">
                        ...
                        <div class="flex flex-col space-y-4 hidden transition-all duration-500" id="end">
                            <div class="relative">
                                <input id="name" name="name" type="text" placeholder="Как вас называть?"
                                    value="{{ old('name') }}"
                            ...
                            <div class="relative">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <label class="cursor-pointer">
                                        ...
                                        <div
                                            class="px-4 py-3 border-2 border-gray-300 rounded-lg peer-checked:border-blue-600 peer-checked:bg-blue-50 transition-all text-center">
                                    ...
                                    <label class="cursor-pointer">
                                        ...
                                        <div
                                            class="px-4 py-3 border-2 border-gray-300 rounded-lg peer-checked:border-green-600 peer-checked:bg-green-50 transition-all text-center">
    ...
    <script>
        ...
        email.addEventListener('paste', () => setTimeout(validateEmail, 0));
        ...
        // Глобальное обновление состояния кнопок (кроме next_btn - она обновляется в validateEmail)
