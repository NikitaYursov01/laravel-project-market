...
<div class="max-w-6xl mx-auto px-3 sm:px-4 py-5 sm:py-8">
    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
        <h2 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Лента заказов</h2>
        
        <p class="text-sm sm:text-base text-gray-600 mb-5 sm:mb-6">Здесь будут отображаться доступные заказы от других пользователей.</p>
        
        <!-- Фильтры -->
        <div class="mb-5 sm:mb-6 p-4 sm:p-5 bg-gray-50 rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3 sm:gap-4">
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Категория</label>
                    <select class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm sm:text-base">
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Срок</label>
                    <select class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm sm:text-base">
                ...
                <div>
                    ...
                    <button class="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm sm:text-base">
                        Применить фильтры
                    </button>
                </div>
            </div>
        ...
        <div class="space-y-4">
            <!-- Заказ 1 -->
            <div class="border rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow">
                <div class="flex flex-col lg:flex-row justify-between items-start gap-4 mb-4">
                    ...
                    <div class="text-left lg:text-right">
                        <div class="text-xl sm:text-2xl font-bold text-blue-600 mb-1 sm:mb-2">5 000 ₽</div>
                        <div class="text-xs sm:text-sm text-gray-500">2 часа назад</div>
                    </div>
                </div>
            ...
            <div class="border rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow">
                <div class="flex flex-col lg:flex-row justify-between items-start gap-4 mb-4">
                    ...
                    <div class="text-left lg:text-right">
                        <div class="text-xl sm:text-2xl font-bold text-blue-600 mb-1 sm:mb-2">3 000 ₽</div>
                        <div class="text-xs sm:text-sm text-gray-500">5 часов назад</div>
                    </div>
                </div>
                <p class="text-sm sm:text-base text-gray-600 mb-4 leading-6">
            ...
            <div class="border rounded-lg p-4 sm:p-6 hover:shadow-md transition-shadow">
                <div class="flex flex-col lg:flex-row justify-between items-start gap-4 mb-4">
                    ...
                    <div class="text-left lg:text-right">
                        <div class="text-xl sm:text-2xl font-bold text-blue-600 mb-1 sm:mb-2">8 000 ₽</div>
                        <div class="text-xs sm:text-sm text-gray-500">1 день назад</div>
                    </div>
                </div>
                <p class="text-sm sm:text-base text-gray-600 mb-4 leading-6">
