        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-3">
                @forelse($notifications as $notification)
                    <div
                        class="flex items-start gap-4 p-4 rounded-lg {{ $notification->isRead() ? 'bg-gray-50' : 'bg-blue-50 border border-blue-200' }}">
                        <div
                            class="w-10 h-10 rounded-full {{ $notification->is_important ? 'bg-red-100 text-red-600' : 'bg-blue-100 text-blue-600' }} flex items-center justify-center flex-shrink-0">
                            <i
                                class="fa fa-{{ $notification->type === 'order_created' ? 'shopping-cart' : ($notification->type === 'chat_message' ? 'comment' : ($notification->type === 'order_closed' ? 'check-circle' : 'info')) }}"></i>
                        </div>
                        <div class="flex-1">
