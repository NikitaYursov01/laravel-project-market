            ...
            <div class="rounded-[28px] bg-[#f3f3fb] px-5 sm:px-10 pt-6 sm:pt-8 pb-8 sm:pb-10">
                ...
                <div class="mt-8 sm:mt-10">
                    <div
                        ...
                        порядок и условия обработки персональных данных Оператором онлайн-сервиса<span
                            class="text-[#0081FD] m-0">
                        ...
                        1.2. Сервис представляет собой информационную <span class="text-[#0081FD] m-0">платформу по
                            металлообработке</span>,
                        обеспечивающую взаимодействие между Клиентами и Исполнителями при
                        обязательном участии Менеджера, который <span class="text-[#0081FD] m-0">модератор коммуникаций,
                            контролирует
                            соблюдение правил, сопровождает сделки и фиксирует историю сообщений.</span>
                        1.3. Ключевая особенность Сервиса: <span class="text-[#0081FD] m-0">все коммуникации между Клиентом
                            и
                        ...
                        фильтруется.
                        1.4. <span class="text-[#0081FD] m-0">Политика разработана и применяется в соответствии с
                            законодательством
