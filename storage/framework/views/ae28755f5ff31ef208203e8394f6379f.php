<!-- HEAD ADD CONTENT -->
<?php $__env->startSection('title', 'Регистрация нового профиля'); ?>
<?php $__env->startSection('description', 'Регистрация нового профиля'); ?>
      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-white">
          ...
          <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="email" id="hidden_email" value="<?php echo e(old('email') ?? session('email')); ?>">

            <!-- ПОЧТА -->
            <div class="flex flex-col transition-all duration-500" id="first">
              <div class="relative">
                <input id="email" type="email" placeholder="Электронная почта"
                  value="<?php echo e(old('email') ?? session('email')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col space-y-4 hidden transition-all duration-500" id="end">
              <div class="relative">
                <input id="name" name="name" type="text" placeholder="Как вас называть?" value="<?php echo e(old('name')); ?>"
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none transition-colors <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="relative">
                <input id="password" name="password" type="password" placeholder="Придумайте пароль"
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none transition-colors <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
              ...
              <div class="relative">
                <input id="password_confirmation" name="password_confirmation" type="password"
                  ...
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none transition-colors <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div class="flex flex-col space-y-4 hidden transition-all duration-500" id="confirm">
              <div class="relative">
                <input id="verifycode" name="verifycode" type="text" placeholder="****" maxlength="4"
                  class="tracking-[5px] w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none transition-colors text-center text-lg font-mono <?php $__errorArgs = ['verifycode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
          ...
          <button onclick="location.href = '<?php echo e(route('main')); ?>'"
  ...
  <script>
    ...
    verifycode.addEventListener('input', async () => {
      ...
      if (!verifycode.value) {
        ...
        try {
          const response = await fetch('<?php echo e(route("verify.code")); ?>', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
              'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    async function confirm() {
      ...
      try {
        const response = await fetch('<?php echo e(route("send.verification.code")); ?>', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php echo $__env->make('componet.shablon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Huawei Matebook\Desktop\Проект\laravel-project-market\resources\views/auth/signup.blade.php ENDPATH**/ ?>