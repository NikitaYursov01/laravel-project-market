  ...
  <div class="flex justify-between items-center" id="descktop">
    ...
    <div class="relative flex items-center gap-4">
      ...
      <?php if(auth()->guard()->check()): ?>
        <!-- search -->
        <a href="<?php echo e(route('profile')); ?>"><li
...
<?php /**PATH C:\Users\Huawei Matebook\Desktop\Проект\laravel-project-market\resources\views/componet/content/header.blade.php ENDPATH**/ ?>