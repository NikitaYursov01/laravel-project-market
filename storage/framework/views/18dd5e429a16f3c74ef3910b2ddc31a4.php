<!-- HEAD ADD CONTENT -->
<?php $__env->startSection('title', 'Найдите лучших специалистов'); ?>
<?php $__env->startSection('description', 'Платформа для поиска профессионалов и специалистов'); ?>
        ...
        <div class="structure relative z-10 mx-auto px-3 sm:px-4 py-6 sm:py-10">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-16 gap-4 sm:gap-0">
                ...
                <div class="flex gap-2 sm:gap-3 w-full sm:w-auto">
                    <?php if(auth()->guard()->check()): ?>
                        <button onclick="location.href = '<?php echo e(route('profile')); ?>'"
                    ...
                    <?php else: ?>
                        <button onclick="location.href = '<?php echo e(route('register.form')); ?>'"
                            class="flex-1 sm:flex-none px-4 sm:px-6 py-2 border border-green-400 text-green-400 rounded-full hover:bg-green-400/10 transition-colors text-sm sm:text-base">
                            Создать профиль
                        </button>
                        <button onclick="location.href = '<?php echo e(route('login.form')); ?>'"
            ...
            <div class="max-w-2xl">
                <h3 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-6 sm:mb-8 leading-tight">
                    Начните <span class="text-blue-400">быстрый</span> поиск <font class="text-blue-400">нужной детали
                    </font> прямо
                    сейчас!
                </h3>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-white text-xs sm:text-sm mt-3 sm:mt-4">
                        ...
                        <a href="<?php echo e(route('term.access')); ?>" class="underline hover:text-white">соглашение</a> и
                        <a href="<?php echo e(route('term.politic')); ?>" class="underline hover:text-white">политику
        ...
        <div class="structure px-4 sm:px-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
                ...
                <div
                    ...
                    <!-- icon -->
                    <span
                        class="rounded-full bg-gray-100 w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center mb-4 sm:mb-6">
...
<?php echo $__env->make('componet.shablon', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Huawei Matebook\Desktop\Проект\laravel-project-market\resources\views/home.blade.php ENDPATH**/ ?>